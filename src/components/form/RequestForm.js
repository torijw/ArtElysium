      ...
      <Container fluid className="p-0">
        ...
        <div className="my-5" id="form-area">
          <section id="request-form" className="my-5">
            <h3 className="text-center mb-4">{titles[index - 1]}</h3>
            <Form id="formpage" onSubmit={submitFormData}>
              ...
              <div className="d-flex w-50 my-5 mx-auto">
                <button
                  type="button"
                  onClick={prevButton}
                  className="btn dark me-5 right"
                  disabled={index === 1}
                >
                  &lt; Previous
                </button>
                <button type="submit" className="btn dark left">
                  {index == totalSteps ? "Submit" : "Next >"}
                </button>
              </div>
              <div
        ...
        <Modal show={submitted}>
          <Modal.Body>
            Thank you for submitting a request, we will get back to you by email
            as soon as possible!
          </Modal.Body>
          <Modal.Footer>
